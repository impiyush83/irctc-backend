...
routes.get(`/unconnectedCity`, auth.HasRole('admin'), CityHandler.getUnconnectedCity)
routes.get(`/mostcrossovercity`, auth.HasRole('admin'), CityHandler.getCityWithMostCrossovers)
